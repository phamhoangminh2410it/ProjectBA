...
namespace ProjectBA.Controllers
{
    ...
    public class BenhAnNgoaiTruMatController : Controller
    {
        ...
        public BenhAnNgoaiTruMatController(ILogger<HomeController> logger, IBenhAnNgoaiTruMatServices services, HospitalContext context, IConverter converter, ICompositeViewEngine viewEngine, IWebHostEnvironment webHostEnvironment)
        {
            _logger = logger;
            _services = services;
            _context = context;
