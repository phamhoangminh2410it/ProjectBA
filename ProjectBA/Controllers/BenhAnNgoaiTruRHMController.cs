...
namespace ProjectBA.Controllers
{
    ...
    public class BenhAnNgoaiTruRHMController : Controller
    {
        ...
        public BenhAnNgoaiTruRHMController(ILogger<HomeController> logger, IBenhAnNgoaiTruRHMServices services, HospitalContext context, IConverter converter, ICompositeViewEngine viewEngine, IWebHostEnvironment webHostEnvironment)
        {
            _logger = logger;
            _services = services;
            _context = context;
        ...
        [HttpPost("PDFBANgoaiTruRHM")]
        public async Task<dynamic> PDFBANgoaiTruRHM()
        {
            ...
            PartialViewResult partialViewResult = PartialView("PDFBenhAnNgoaiTruRHM", data);
