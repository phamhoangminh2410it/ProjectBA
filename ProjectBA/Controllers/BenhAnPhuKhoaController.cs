...
namespace ProjectBA.Controllers
{
    ...
    public class BenhAnPhuKhoaController : Controller
    {
        ...
        public BenhAnPhuKhoaController(ILogger<HomeController> logger, IBenhAnPhuKhoaServices services, HospitalContext context, IConverter converter, ICompositeViewEngine viewEngine, IWebHostEnvironment webHostEnvironment)
        {
            _logger = logger;
            _services = services;
            _context = context;
        ...
        [HttpPost("PDFBAPhuKhoa")]
        public async Task<dynamic> PDFBAPhuKhoa()
        {
            ...
            PartialViewResult partialViewResult = PartialView("PDFBenhAnPhuKhoa", data);
